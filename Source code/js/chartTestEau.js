...
function moyenneEnCours() {
    ...
    if(dateStart != dateStartOld || dateEnd != dateEndOld){
        ...
        document.getElementsByClassName("dataDashboard")[1].innerHTML = "<h3>Consommation totale</h3><h5>sur la periode selectionnee :</h5><h1>" + consomationTotPeriode + "litres</h1>";
    };
}
