  ...
  if(!isset($userErrors)){
    try{
      ...
      if($manager->exist($user)){
        ...
        $manager->add($user);
        if($manager->exist($user)){
          $success = '<strong>Votre inscription est terminée.</strong>';
        }
      }
      $pdo = null;
    ...
    <form method="post" action="">
      <div class="container" style="margin-top:10%;">
        ...
        <div class="form-group row">
          <label for="lastName" class="col-2 col-form-label  col-form-label-sm">
        ...
        <div class="form-group row">
          <label for="firstName" class="col-2 col-form-label  col-form-label-sm">
        ...
        <div class="form-group row">
          <label for="birthDate" class="col-2 col-form-label col-form-label-sm">
            Date de naissance<b style="color:orange;">*</b>
          </label>
          <div class="col-8">
            <input name="birthDate" id="birthDate" type="date"
            class="form-control form-control-sm"
            value="<?= isset($_SESSION['post']['birthDate']) ? htmlspecialchars($_SESSION['post']['lastName'])
            : '' ?>" required/>
        ...
        <div class="form-group row">
          <label for="email" class="col-2 col-form-label  col-form-label-sm">
        ...
        <div class="form-group row">
          <label for="gender" class="col-2 col-form-label col-form-label-sm">
        ...
        <div class="form-group row">
          <label for="phone" class="col-2 col-form-label col-form-label-sm">
            N° de téléphone
          </label>
          <div class="col-8">
        ...
        <div class="form-group row">
          <div class="offset-sm-0 col-sm-8">
            <button name="sub" type="submit" class="btn btn-primary" value="subscribe">
            M'inscrire
          </button>
        </div>
      </div>
